...
infection = function(data, v, condition){
  ...
  infection_change = function(condition2, r = 1, pc){
    
    infection_radius = v[infection_index] * infection_speed[infection_index] * r
  ...
  condition = infection_change(condition, 1, pc)
  condition = infection_change(condition, 2, pc/4)
...
## Step 11: Policy Implementation

## Step 12: Track and isolate close contacts

## Step 13: Temporary hospital and doctors
